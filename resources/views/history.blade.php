        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white border shadow-sm sm:rounded-2xl border-slate-200">
                <div class="flex items-center justify-between p-6 bg-white border-b border-slate-200">
                    ...
                    <!-- Tombol Export (Hiasan/Future feature) -->
                    {{-- <button class="flex items-center gap-2 px-4 py-2 text-sm font-medium transition rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-600">
